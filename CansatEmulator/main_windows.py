...
def first_run_procedure():
    ...
    if get_virtual_pair_conf() is None:
        ...
        if _is_admin():
            ...
            print(
                "⚠️Warning: You're about to install a kernel driver: com0com. Press enter to install...")
            input()
            install_com0com()
        else:
            print(
                "⚠️This process is currently running in user mode, administrative privilege is required")
